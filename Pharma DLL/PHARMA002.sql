...
--   Script Created at           : 06/10/2018 04:46:30 ã
--   Notes                       : 
--
...
--   Sequences: 14 
--   Tables: 20         Columns: 164        Constraints: 62     
--   Triggers: 14 
--   Views: 3           Columns: 16         
...
--
CREATE TABLE PHARMA.RTN_ITEMS_UNITS
(
  ITEM_ID      NUMBER,
  UNIT_ID      NUMBER,
  CREATE_DATE  DATE                             DEFAULT SYSDATE,
...
--
CREATE UNIQUE INDEX PHARMA.RTN_ITEMS_UNITS_PK ON PHARMA.RTN_ITEMS_UNITS
(ITEM_ID, UNIT_ID)
TABLESPACE USERS
PCTFREE    10
INITRANS   2
...
-- 
ALTER TABLE PHARMA.RTN_ITEMS_UNITS ADD (
  CONSTRAINT RTN_ITEMS_UNITS_PK
  PRIMARY KEY
  (ITEM_ID, UNIT_ID)
  USING INDEX PHARMA.RTN_ITEMS_UNITS_PK
  ENABLE VALIDATE);
