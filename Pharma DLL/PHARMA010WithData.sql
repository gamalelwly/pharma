...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "TRX_DAILY_SALES_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "CUSTOMER_TOTAL_DUES_V" ("CUSTOMER_ID", "CUSTOMER_NAME", "TOTAL_DUE") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "ITEMS_MIN_ALARM" ("ITEM_ID", "ITEM_NAME", "UNIT_ID", "UNIT_NAME", "MIN_QUANT", "BALANCE") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "MONTHS_NAMES_V" ("ID", "MONTH_NAME", "LOCALE") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "REPS_CUSTOMERS_AND_SECTIONS_V" ("REP_ID", "REP_NAME", "CUSTOMER_ID", "CUSTOMER_CODE", "CUSTOMER_NAME", "SECTION_ID", "SECTION_CODE", "SECTION_NAME") AS 
  SELECT REPS.REP_ID,
       REPS.REP_NAME,
       CUSTS.CUSTOMER_ID,
       CUSTS.CUSTOMER_CODE,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "REPS_ITEMS_V" ("REP_ID", "REP_NAME", "ITEM_ID", "ITEM_NAME", "ITEM_CODE", "MANUFACTURE_ID") AS 
  SELECT REPS.REP_ID,
       REPS.REP_NAME,
       ITEMS.ITEM_ID,
       ITEMS.ITEM_NAME,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "TRX_DAILY_SALES_V" ("TRX_ID", "TRX_CODE", "TRX_DATE", "DAYS", "TRX_TYPE", "CUSTOMER_ID", "AMOUNT") AS 
  SELECT TRX_ID,
          TRX_CODE,
          TRX_DATE,
